...
export function ImportantMessage({ content, oldMessage }: Props) {
  ...
  if (oldMessage) {
    return (
      <div className="bg-[var(--current-theme-color-200)]  p-4 my-12">
        <Subtitle2>
          <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-[var(--current-theme-color-100)] border border-[var(--current-theme-color-600)] mr-2">
            i
          </span>
