import {
  ...
  usePaneLayout,
  useStructureTool
} from "./chunk-5JFVM57L.js";
import "./chunk-CBL6KD4L.js";
import {
  Button,
  ErrorBoundary,
  NEVER,
...
import "./chunk-E7SWEUEV.js";
import "./chunk-VIHF5IGP.js";
import "./chunk-PTHNJC3J.js";
import {
  require_dist
} from "./chunk-UYN5T6UH.js";
import "./chunk-2PQMUUO4.js";
import {
  SyncIcon,
  WarningOutlineIcon
...
// ../../node_modules/.pnpm/sanity@3.99.0_@emotion+is-prop-valid@1.2.2_@types+node@20.19.27_@types+react-dom@19.2.3_@type_r2snm5mshiz3xb2kxknafewpxe/node_modules/sanity/lib/_chunks-es/index3.mjs
...
var paneMap = {
  component: (0, import_react.lazy)(() => import("./_chunks-es-5WQY2LGN.js")),
  document: (0, import_react.lazy)(() => import("./pane-ELCRXVFS.js").then(function(n) {
    return n.pane;
  })),
  documentList: (0, import_react.lazy)(() => import("./pane-ELCRXVFS.js").then(function(n) {
    return n.pane$1;
  })),
  list: (0, import_react.lazy)(() => import("./index2-MN5XZ3QI.js"))
};
...
//# sourceMappingURL=index3-BO5OUPWX.js.map
